...
namespace ChromiumWebBrowser.Core.Misc.Bootstrap
{
    public class AppEnvironmentBuilder
    {
        ...
        private const string _MISC_DIR = "misc";
        ...
        private AppEnvironment GetTemporaryRegistryImpl(Assembly asm)
        {
            ...
            res.MiscDir = GetDir(res.RootDir, _MISC_DIR);
            ...
            res.CefBinariesDir = GetCefBinariesDir(res.IsDeveloperMode, res);

            // others
            res.AssemblyName = asm.GetName().Name;
            res.AppNameSlug = res.AssemblyName.GenerateSlug2();
            res.AppVersion = AppVersionBuilder.GetVersion(asm);
